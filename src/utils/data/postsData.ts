...
const posts: Posts[] = [
  {
    ...
    publishDate: new Date('27 April 2023'),
    categories: [
      {
        name: 'Pemerintahan',
        slug: 'pemerintahan',
    ...
    content: `
    <p>Pemerintah Provinsi Jawa Barat resmi luncurkan Smart Jabar, sebuah ekosistem teknologi untuk Jabar yang terdiri dari E–Office, Dashboard Jabar dan Jabar Skytrek. Launching aplikasi ini diresmikan langsung oleh Sekretaris Daerah Provinsi Jawa Barat, Setiawan Wangsaatmaja, bertempat di Jabar Command Center, Gedung Sate, Kota Bandung, Rabu (5/4/2023).</p>
    <p>“Smart Jabar merupakan aplikasi yang dapat mengakses berbagai layanan administrasi pemerintahan dengan menggunakan sistem Single Sign On untuk mempermudah akses informasi. Hadirnya smart Jabar ini berdampak pada peningkatan kualitas layanan bagi internal maupun publik dalam mengakses melalui teknologi digital” tutur Ika Mardiah selaku Kepala Dinas Komunikasi dan Informatika Jawa Barat.</p> <p>Teknologi digitalisasi merupakan salah satu solusi dari permasalahan yang dihadapi oleh daerah yang ada di Indonesia. Teknologi di setiap masanya pasti berkembang, karena teknologi bersifat dinamis. “Lebih baik kita update apa yang kita punya, dibandingkan harus update perkembangan baru lagi” papar Setiawan. </p><p>“Untuk sementara hanya ada dua daerah yang tergabung dalam aplikasi smart Jabar, Kabupaten Bandung dan Kabupaten Sumedang. Kita akan terus melihat perkembangan di setiap daerahnya. Karena, kemajuan suatu daerah dapat dilihat dari penggunaan teknologi digitalisasi.” ujarnya.</p><p>“Pada dua tahun silam, di saat situasi pandemic, andai kata pemerintah daerah tidak terbiasa dan tidak memiliki inovasi teknologi, kita akan sangat kerepotan dalam mengatasi kondisi darurat dalam skala provinsi terbesar di Indonesia”, ujar Bedi, Ketua Komisi I DPRD Jawa Barat.</p><p>Baca Juga Artikel Menarik Lainya Disini</p><a href='https://smartnation.id/langkah-pemerintah-kota-bandung-dalam-implementasi-smart-tourism/'> Langkah Pemerintah Kota Bandung dalam Implementasi Smart Tourism</a><p>Terobosan Diskominfo Jabar biasanya hanya meluncurkan satu produk saja, namun kali ini perdana Diskominfo launching empat produk sekaligus dalam waktu yang bersamaan. Melalui peresmian ini, Diskominfo mendapatkan apresiasi dan dukungan sepenuhnya oleh Komisi I DPRD provinsi Jawa Barat.</p><p>“Teknisnya dari Diskominfo sudah siap, makanya kita launching. Kita berupaya capacity building teman-teman Diskominfo terus dilakukan. Jadi launching bukan berarti selesai segalanya, justru kita memulai dan capacity harus ditingkatkan,” tuturnya.</p><p>Keunggulan dari aplikasi Smart Jabar adalah hanya sekali login untuk berbagai aplikasi dengan menggunakan NIP untuk ASN dan NIK untuk masyarakat sipil yang ingin mengakses layanan administrasi pemerintahan.</p><p>Selanjutnya, Ekosistem E–Office digunakan untuk mengelola pengarsipan dokumen penting pemerintah daerah. Hanya dengan menggunakan layanan Ekosistem E–Office, pemerintah Provinsi, Kota dan Kabupaten dapat mengakses dokumen dinas secara jarak jauh dan memanfaatkan teknologi digital aplikasi e-Office.</p><p>Sedangkan Dashboard Jabar hanya boleh diakses khusus untuk eksekutif. Seperti, Gubernur, Wakil Gubernur dan Sekretaris Daerah untuk percepatan proses pemerintahan yang berbasiskan data dan pengambilan kebijakan pemerintah.</p><p>Terakhir, Jabar Skytrek disebut bertujuan untuk menganalisis data dengan menggunakan sensor dan satelit dalam mengimplementasikan “good data, good decision”.  Data dari aplikasi Skytrek dapat diperoleh secara realtime  dan live streaming  yang dapat diakses langsung oleh masyarakat hanya dengan menggunakan channel televisi.</p>
    `,
    views: 871,
    timestamp: new Date(),
  },
  ...
  {
    id: nanoid(16),
    title: 'Tingkatkan SDM Daerah Melalui Seminar Smart City 2022',
    slug: generateCreateSlug(
  ...
  {
    id: nanoid(16),
    title: 'KPK ingin Menekan Korupsi dengan Digitalisasi Sistem Pemerintahan',
    slug: generateCreateSlug(
  ...
  {
    id: nanoid(16),
    title: 'Gunakan Teknologi RFID Untuk Mendeteksi Plat Nomor Kendaraan',
    slug: generateCreateSlug(
  ...
  {
    id: nanoid(),
    title: 'Konsep Smart Living, Mengedepankan Keamanan dan Kenyamanan',
    slug: generateCreateSlug(
...

  {
    ...
    content: `Smart branding merupakan salah satu pilar dari pendekatan smart city yang memiliki definisi strategi memasarkan sebuah kota atau wilayah sehingga mampu menarik ekosistem sekitar, baik itu warga, masyarakat umum, ataupun pelaku bisnis. Aspek smart branding tidak hanya terbatas pada pengembangan smart branding di area pariwisata. Menurut Hari Kusdaryanto, CIO Citiasia, ekosistem bisnis dan ekonomi kreatif juga menarik untuk dikembangkan. Ketika memilih area pariwisata untuk dikembangkan sebagai smart branding, Hari melihat masih banyak daerah yang implementasinya kurang tepat karena masih terlalu fokus pada destinasi yang sebenarnya bisa lebih dari itu. Hari menjelaskan penilaian smart branding di pagelaran Indonesia Smart Nation Awards (ISNA) pada 17 November 2022 lalu, “Kalau hanya ‘jualan’ air terjun, akan selalu ada air terjun yang lebih indah,” tambah Hari. Objek wisata air terjun akan lebih diminati wisatawan jika tersedia amenitas atau fasilitas pendukung yang memadai. “Contohnya perjalanan ke sana mudah, ada tempat ganti yang layak di lokasi, dan lain sebagainya,” tambah Hari mencontohkan. Keterlibatan masyarakat juga penting dalam menyukseskan smart branding. Hari mengambil contoh Kabupaten Banyuwangi yang berhasil mengajak warga untuk berpartisipasi melalui program Smart Kampung. Melalui program tersebut, warga mendapat akses internet dan literasi digital agar mampu mengembangkan diri.  “Sehingga warga desa atau karang taruna di sana mampu melakukan branding sendiri terhadap kampungnya,” tambah Hari. Karena selain memperkaya daya tarik sebuah wilayah, inovasi yang lahir dari warga itu sendiri lebih terjaga keberlanjutannya sehingga pemerintah dapat fokus mengerjakan amenitas besar seperti membuat bandara, pelebaran jalan, dan lain-lain. Pemerintah daerah seharusnya juga aktif melakukan kerjasama atau co-creation dengan pelaku usaha. Contohnya untuk menjual produk unggulan UMKM secara online, pemerintah dapat melakukan kerjasama dengan marketplace yang sudah ada. “Cara ini lebih efektif dibanding membangun e-commerce sendiri,” tambah Hari. Pemerintah daerah juga bisa mengambil peran dengan memberi kemudahan pengusaha dalam mendapatkan izin usaha atau pendaftaran merek. Pemerintah daerah lebih baik fokus pada tugas pokok dan fungsinya, seperti kebijakan, infrastruktur, dan literasi warga. Dengan begitu, keberlanjutan inisiatif smart branding pun dapat selalu terjaga. Jadi, saat akan menerapkan smart branding sebaiknya sebuah daerah tidak hanya terpaku pada pariwisata dan memperhatikan aspek lain yang bisa menjadi potensi. Jika Anda butuh konsultansi, silahkan kunjungi akun Instagram @citiasiainc untuk informasi lebih lanjut.`,
  },
  {
    id: nanoid(),
    title:
  ...
  {
    id: nanoid(),
    title: 'DPMPTSP Kabupaten Blitar Raih Penghargaan “Smart Branding” 2020',
    slug: generateCreateSlug(
...

  {
    ...
    categories: [
      ...
      { name: 'Citiasia Inc', slug: 'citiasia-inc' },
      { name: 'Nasional', slug: 'nasional' },
      { name: 'Smart City', slug: 'smart-city' },
      { name: 'SmartNation 2022', slug: 'smartnation-2022' },
    ],
    views: 100,
    timestamp: new Date(),
    excerpt: `IKN (Ibu Kota Nusantara) merupakan pusat pemerintahan baru negara Indonesia yang berada di Pulau Kalimantan, tepatnya Kalimantan Timur. Dalam pembangunannya, Menteri Pekerjaan Umum dan Perumahan Rakyat (PUPR) Basuki Hadimuljono mengatakan Ibu Kota Negara Baru akan mengusung konsep Smart Forest, (Maharani, 2022).`,
    content:
      '<p style="text-align: justify;"><span style="font-weight: 400;">IKN (Ibu Kota Nusantara) merupakan pusat pemerintahan baru negara Indonesia yang berada di Pulau Kalimantan, tepatnya Kalimantan Timur. Dalam pembangunannya, </span><span style="font-weight: 400;">Menteri Pekerjaan Umum dan Perumahan Rakyat (PUPR) Basuki Hadimuljono mengatakan Ibu Kota Negara Baru akan mengusung konsep </span><i><span style="font-weight: 400;">Smart Forest, (Maharani, 2022)</span></i><span style="font-weight: 400;">.</span></p>\n\n<h3 style="text-align: justify;"><b><i>FOREST SMART CITY</i></b></h3>\n<p style="text-align: justify;"><i><span style="font-weight: 400;">Smart forest city </span></i><span style="font-weight: 400;">adalah kota yang menganut konsep habitat manusia dan infrastruktur kota sebagai bagian dari ekosistem hutan. Untuk memastikan dapat terwujud, perlu mengikuti kriteria menurut Maharani (2022).</span></p>\n<p style="text-align: justify;"><i><span style="font-weight: 400;">Smart forest city </span></i><span style="font-weight: 400;">dapat memastikan bahwa </span><i><span style="font-weight: 400;">footprints</span></i><span style="font-weight: 400;"> dari kawasan terbangun dan karbon kota tidak boleh mengganggu hutan dan bahkan bisa memperbaikinya.&nbsp;</span><span style="font-weight: 400;">Selain itu, sistem dan teknologi yang dipakai sebagai sarana prasarana harus berkelanjutan dan bisa menurunkan maksimal </span><i><span style="font-weight: 400;">footprints</span></i><span style="font-weight: 400;"> kota di tengah hutan Pulau Kalimantan.&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Presiden Joko Widodo (Jokowi) meyakini Ibu Kota Negara (IKN) Nusantara akan menjadi representasi bangsa yang unggul dengan mewujudkan </span><i><span style="font-weight: 400;">smart city </span></i><span style="font-weight: 400;">(kota cerdas), kota modern berkelanjutan, serta memiliki standar internasional sehingga menjadi contoh bagi pembangunan kota-kota lain di Indonesia, (Kementerian Pekerjaan Umum dan Perumahan Rakyat, 2022).&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Mantan Gubernur DKI Jakarta, pemerintah juga telah membuat konsep agar transportasi di IKN mayoritasnya adalah transportasi publik, bukan kendaraan pribadi. Ia menyebutkan, sebanyak 80 persen kendaraan yang ada di IKN atau mobilitas didukung transportasi publik. "80 persen itu didukung energi hijau. Sehingga di IKN diperkirakan oleh city planner dari satu titik ke titik lain itu memakan waktu 10 menit," jelasnya (Aditya, 2022).</span></p>\n<p style="text-align: justify;"><i><span style="font-weight: 400;">Smart forest city </span></i><span style="font-weight: 400;">akan menjadi salah satu instalasi pendukung energi terbarukan yang akan memenuhi 100% kebutuhan energi IKN. Dengan begitu, pada tahun 2045 akan meningkatkan efisiensi energi sebanyak 60% serta memunculkan&nbsp; </span><i><span style="font-weight: 400;">Net Zero Emissions</span></i><span style="font-weight: 400;"> di IKN pada tahun yang sama,&nbsp; (Kementerian Pekerjaan Umum dan Perumahan Rakyat, 2022).</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Oleh karena itu, pembangunan Ibu Kota Nusantara (IKN) akan menjadi kota yang terbuka, inklusif, dan ramah untuk seluruh masyarakat hidup berdampingan. Selain itu, Ibu Kota ini akan dijalankan dengan teknologi luar biasa canggih bagi para penduduknya untuk mendapatkan very high dari E-Government index oleh PBB dengan 100% konektivitas digital dan tik untuk kebutuhan bisnis yang dijalankan melalui layanan digital.&nbsp;</span></p>\n<a href="http://smartnation.id/konsep-forest-smart-city-menjadi-energi-terbarukan-di-ikn/"><em><strong>Reference</strong></em></a>',
  },
  {
    id: nanoid(),
    title:
    ...
    views: 100,
    timestamp: new Date(),
    excerpt: `Platform digital ini merupakan gambaran dari Ibu Kota Negara (IKN) Nusantara, yang pada kenyataannya masih dalam tahap pembangunan. Namun, dengan diluncurkannya platform ini pada Jumat (28/10/2022), masyarakat dapat melihat IKN secara gratis melalui metaverse yang dapat diakses di link play.jagat.io. (tribunnews.com, 2022)  `,
    content:
      '<p style="text-align: justify;"><i><span style="font-weight: 400;">Platform </span></i><span style="font-weight: 400;">digital ini merupakan gambaran dari Ibu Kota Negara (IKN) Nusantara, yang pada kenyataannya masih dalam tahap pembangunan. Namun, dengan diluncurkannya </span><i><span style="font-weight: 400;">platform</span></i><span style="font-weight: 400;"> ini pada Jumat (28/10/2022), masyarakat dapat melihat IKN secara gratis melalui </span><i><span style="font-weight: 400;">metaverse</span></i><span style="font-weight: 400;"> yang dapat diakses di link</span><i><span style="font-weight: 400;"> play.jagat.io. (tribunnews.com, 2022)</span></i></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Hal ini diperkuat dengan pernyataan dalam konferensi pers dari Co-Founder sekaligus CEO Jagat Barry Beagen dalam kesempatan yang sama mengatakan bahwa saat ini belum ada biaya untuk mengakses IKN di Jagat Nusantara. Masyarakat hanya diminta unduh atau </span><i><span style="font-weight: 400;">download </span></i><span style="font-weight: 400;">jika ingin menikmati teknologi tersebut. (</span><i><span style="font-weight: 400;">suara.com</span></i><span style="font-weight: 400;">, 2022)</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Jagat Nusantara adalah </span><i><span style="font-weight: 400;">platform </span></i><span style="font-weight: 400;">media sosial masa depan, </span><i><span style="font-weight: 400;">platform e-commerce</span></i><span style="font-weight: 400;"> masa depan, serta </span><i><span style="font-weight: 400;">platform</span></i><span style="font-weight: 400;"> olahraga dan hiburan masa depan. </span><i><span style="font-weight: 400;">Platform </span></i><span style="font-weight: 400;">ini dapat menjadi jembatan antara ekonomi digital dan ekonomi riil. Selain itu, pengguna juga dapat mengadakan rapat, pertemuan, nonton bareng film, konser virtual, pertunjukan, memamerkan karya digital, dan interaksi lainnya hanya menggunakan telepon genggam dan </span><i><span style="font-weight: 400;">website</span></i><span style="font-weight: 400;">, (</span><i><span style="font-weight: 400;">kompas.com</span></i><span style="font-weight: 400;">, 2022).\u00a0</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Menurut Presiden Joko Widodo, Jagat Nusantara menjadi salah satu kesempatan untuk berbagi ilmu dan bertemu dengan orang-orang hebat dari seluruh dunia. Selain itu, memberikan peluang bagi siapapun yang ingin memperkenalkan produk secara global, (</span><i><span style="font-weight: 400;">suara.com</span></i><span style="font-weight: 400;">, 2022).</span></p>\n<p style="text-align: justify;"><i><span style="font-weight: 400;">"Para seniman Tanah Air juga dapat berkreasi dan menikmati hasilnya seperti konser musik. Kita juga bisa berolahraga, akan menjadi pengalaman bersama yang seru. Ayo generasi muda mari kita membangun Ibu Kota Nusantara bersama-sama melalui inovasi dan kreativitas,"</span></i><span style="font-weight: 400;"> katanya.</span></p><img class="wp-image-9937" src="http://smartnation.id/wp-content/uploads/2022/11/jagat_nusantara_platform_media_sosial_masa_depan-300x169.jpg" alt="" width="323" height="182" /> Platform Digital Jagat Nusantara Sumber: Ami Heppy S<h4><b>TATA CARA MEMBUAT AKUN JAGAT NUSANTARA</b></h4>\n<span style="font-weight: 400;">Untuk mengunjungi </span><i><span style="font-weight: 400;">platform </span></i><span style="font-weight: 400;">Jagat Nusantara, pengguna perlu memahami tata cara pembuatan akun di link </span><i><span style="font-weight: 400;">play.jagat.io. </span></i><span style="font-weight: 400;">Adapun tata cara membuat akun, sebagai berikut, (</span><i><span style="font-weight: 400;">suara.com,</span></i><span style="font-weight: 400;"> 2022):</span>\n<ul>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Masuk ke laman Jagat, pilih tombol \'Enter Jagat\' yang berwarna merah.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Jika sudah muncul halaman login, klik \'Create Account\'.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Masukkan alamat email aktif dan klik \'Send Code\' untuk dikirimi kode verifikasi pendaftaran akun.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Masukkan kode, lalu klik \'Next\'.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Masukkan password dan pilih \'Next\'.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Buat nickname atau nama panggilan dan pilih jenis kelamin, kemudian klik \'Enter JAGAT\'.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Buat avatar sesuai keinginan.</span></li>\n \t<li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Apabila sudah sesuai, lanjutkan pendaftaran dengan memilih tombol \'Confirm\'.</span></li>\n</ul>\n<p style="text-align: justify;"><span style="font-weight: 400;">Sementara itu, untuk memulai menjalankan aplikasi di IKN, \u2018klik pintu\u2019 yang bertuliskan \'Into JAGAT\'. Untuk berjalan, pengguna laptop atau PC dapat melakukannya dengan menekan tombol arah atau ASDW pada<em> keyboard.\u00a0</em></span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Namun, jika pengguna ingin melakukan interaksi melalui pesan instan, silahkan klik kolom </span><i><span style="font-weight: 400;">chat </span></i><span style="font-weight: 400;">yang ada di sebelah kiri bawah. Pengguna juga bisa menambahkan teman dengan cara klik profil pada orang yang dituju lalu klik \'ADD\'.</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Pengembangan </span><i><span style="font-weight: 400;">platform </span></i><span style="font-weight: 400;">digital Jagat Nusantara merupakan salah satu upaya agar masyarakat Indonesia melek terhadap perkembangan teknologi yang kian berkembang sangat pesat. Hal ini juga bertujuan untuk memenuhi kebutuhan ekspresi lebih banyak masyarakat Indonesia.</span></p>\n<a href="http://smartnation.id/platform-digital-jagat-nusantara-membangun-kota-menjadi-lebih-modern/"><em><strong>Reference</strong></em></a>\n<p style="text-align: justify;"></p>',
  },

  {
    ...
    views: 100,
    timestamp: new Date(),
    excerpt: `Konsep smart mobility menjadi salah satu bagian dari smart city yang dikembangkan di Indonesia sebagai pembuat sistem transportasi yang ramah lingkungan serta berteknologi tinggi. Pada umumnya, penerapan konsep ini dilakukan di wilayah Ibu Kota yang memiliki berbagai macam moda transportasi publik, di antaranya kereta komuter (KRL), Bus Transjakarta (BRT), MRT, jaringan mikrobus Jaklingko, serta yang baru adalah LRT. 

    Penggunaan teknologi dalam konsep smart mobility diharapkan dapat menjadikan transportasi publik menjadi lebih nyaman, aman, dan dapat diandalkan sehingga lebih mendorong masyarakat beralih ke moda transportasi publik. `,
    content:
      '<p style="text-align: justify;"><span style="font-weight: 400;">Konsep </span><i><span style="font-weight: 400;">smart mobility</span></i><span style="font-weight: 400;"> menjadi salah satu bagian dari </span><i><span style="font-weight: 400;">smart city </span></i><span style="font-weight: 400;">yang dikembangkan di Indonesia sebagai pembuat sistem transportasi yang ramah lingkungan serta berteknologi tinggi. Pada umumnya, penerapan konsep ini dilakukan di wilayah Ibu Kota yang memiliki berbagai macam moda transportasi publik, di antaranya kereta komuter (KRL), Bus Transjakarta (BRT), MRT, jaringan mikrobus Jaklingko, serta yang baru adalah LRT.&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Penggunaan teknologi dalam konsep </span><i><span style="font-weight: 400;">smart mobility </span></i><span style="font-weight: 400;">diharapkan dapat menjadikan transportasi publik menjadi lebih nyaman, aman, dan dapat diandalkan sehingga lebih mendorong masyarakat beralih ke moda transportasi publik.</span></p>\n\n<h4 style="text-align: justify;"><b><i>Apa itu Smart Mobility?&nbsp;</i></b></h4>\n<p style="text-align: justify;"><i><span style="font-weight: 400;">Smart mobility</span></i><span style="font-weight: 400;"> adalah konsep sistem transportasi cerdas, yang memadukan teknologi digital di antara perangkat, kendaraan, dan infrastruktur untuk manajemen lalu lintas. Konsep ini mencakup tidak hanya perangkat dan kendaraan, tetapi juga</span><i><span style="font-weight: 400;"> platform </span></i><span style="font-weight: 400;">data mobilitas.&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Dilansir dari lintasarta, </span><i><span style="font-weight: 400;">smart mobility</span></i><span style="font-weight: 400;"> dapat didefinisikan sebagai pemanfaatan sistem transportasi dengan menggunakan teknologi tinggi berupa teknologi elektronik, komputer, dan telekomunikasi agar dalam penggunaanya dapat memberikan kemudahan dan efisiensi, baik itu dari segi waktu, biaya, ataupun tenaga serta ramah lingkungan. Terlihat bahwa </span><i><span style="font-weight: 400;">smart mobility</span></i><span style="font-weight: 400;"> memiliki ciri-ciri sebagai berikut:</span></p>\n\n<ul>\n \t<li style="font-weight: 400; text-align: justify;" aria-level="1"><b>Mengandalkan instrumen:</b><span style="font-weight: 400;"> sensor pada sistem ini memasok data antara lain data keadaan dan lokasi untuk kendaraan, perangkat portabel/bergerak, dan infrastruktur pada umumnya.</span></li>\n \t<li style="font-weight: 400; text-align: justify;" aria-level="1"><b>Komputatif:</b><span style="font-weight: 400;"> data yang diproduksi sensor tidak dibiarkan begitu saja, tapi diproses baik oleh sensor itu sendiri (</span><i><span style="font-weight: 400;">edge computing</span></i><span style="font-weight: 400;">), oleh perangkat lain yang secara fisik berada di dekat sensor (misalnya, komputer di dalam kendaraan), atau dari jarak jauh (misalnya oleh aplikasi </span><i><span style="font-weight: 400;">Cloud</span></i><span style="font-weight: 400;">).</span></li>\n \t<li style="font-weight: 400; text-align: justify;" aria-level="1"><b>Konektif: </b><span style="font-weight: 400;">data </span><i><span style="font-weight: 400;">output/</span></i><span style="font-weight: 400;">hasil pemrosesan data dibagi antara kendaraan, perangkat bergerak, maupun infrastruktur menggunakan berbagai jenis protokol dan teknologi komunikasi.</span></li>\n \t<li style="font-weight: 400; text-align: justify;" aria-level="1"><b>Reaktif:</b> sistem secara otomatis bereaksi terhadap perubahan keadaan dengan masukan minimal, atau bahkan tanpa campur tangan dari manusia sama sekali.</li>\n</ul>\n<h4><b><i>Penerapan Smart Mobility di Indonesia</i></b></h4>\n<p style="text-align: justify;"><span style="font-weight: 400;">Dalam upaya menerapkan </span><i><span style="font-weight: 400;">smart mobility </span></i><span style="font-weight: 400;">di Indonesia perlu adanya transportasi yang memadai, jika melihat sekilas tentu kalian akan mengatakan DKI Jakarta sebagai salah satu kota dengan moda transportasi terlengkap di Indonesia.&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">DKI Jakarta juga memiliki jalur khusus untuk bus tingkat \u201cJakarta City Tour\u201d dan bus lokal lainnya yang lebih kecil. Penerapan ini memudahkan untuk menjangkau area-area yang lebih luas dan lebih banyak serta yang sulit diakses oleh bus TransJakarta.</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Perlu diketahui jika adanya perkembangan teknologi tidak serta-merta mengembangkan transportasi saja, namun diiringi dengan perkembangan sistem pembayaran sebagai salah satu kemajuan ekonomi di Indonesia.&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Moda transportasi di wilayah DKI Jakarta menggunakan pembayaran menggunakan kartu elektronik sebagai ganti uang tunai, yang dikeluarkan oleh berbagai bank di Indonesia.&nbsp; Kartu elektronik tersebut dapat digunakan untuk menggunakan berbagai jenis moda transportasi seperti MRT, LRT, TransJakarta, kereta </span><i><span style="font-weight: 400;">commuter line</span></i><span style="font-weight: 400;"> bahkan bisa digunakan untuk pembayaran jalan tol dan pembayaran parkir.</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Oleh karena itu, penerapan </span><i><span style="font-weight: 400;">smart mobility</span></i><span style="font-weight: 400;"> di wilayah DKI Jakarta sebagai upaya menanggulangi kemacetan yang kian parah. Kemacetan disebabkan oleh banyaknya volume kendaraan di jalan raya yang sering kali menimbulkan polusi udara.&nbsp;</span></p>\n<p style="text-align: justify;"><span style="font-weight: 400;">Penerapan </span><i><span style="font-weight: 400;">smart mobility </span></i><span style="font-weight: 400;">juga merupakan manifestasi dari perwujudan </span><i><span style="font-weight: 400;">smart city </span></i><span style="font-weight: 400;">yang nantinya akan mengarah pada terwujudnya masyarakat madani bagi wilayah yang bersangkutan. Masyarakat madani sendiri merupakan peradaban manusia yang sudah memiliki tingkat kecerdasan yang lebih baik karena saling terintegrasi dengan memanfaatkan teknologi informasi dan komunikasi dalam berbagai aspek kehidupannya, (hmgp.geo, 2021).</span></p>\n<a href="http://smartnation.id/konsep-smart-mobility-sebagai-upaya-pengembangan-transportasi-di-dki-jakarta/"><em><strong>Referensi</strong></em></a>',
  },
];
