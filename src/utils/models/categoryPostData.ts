...
const categories: Categories[] = [
  ...
  },
  {
    ...
    count: 0,
    description:
      'Indonesia Smart Nation Award (ISNA) diselenggarakan untuk kedua kalinya pada tahun 2016, pada kesempatan ini Citiasia, Inc. menyampaikan hasil riset mengenai indeks daerah dan pengakuan terhadap prestasi lokal yang dirangkum dalam Indonesia Smart Nation Index 2016. Indeks yang disusun oleh Citiasia Center for Smart Nations (CCSN) ini mengevaluasi seluruh wilayah di Indonesia (34 provinsi, 412 kabupaten, dan 93 kota) dengan menggunakan data resmi dari berbagai sumber, menganalisis 72 media cetak nasional dan lokal serta 100 media online untuk mendorong dan mewujudkan cita-cita bersama dalam mewujudkan Indonesia Smart Nation.',
    name: 'ISNA 2016',
    slug: 'isna-2016',
    taxonomy: 'category',
    parent: 90,
  ...
  },
  {
    ...
    count: 11,
    description:
      'Indonesia Smart Nation Award ke-4 2020 diselenggarakan bersamaan dengan Indonesia Smart City Investment Forum (ISCIF) 2020 secara daring melalui platform konferensi Zoom Virtu-Ex pada tanggal 5 Oktober 2020. Tema ISCIF 2020 dan ISNA ke-4 adalah “Smart City 2020: Driving Innovation & Productivity During The Global Pandemic.” Citiasia Center for Smart Nation (CCSN) melakukan survei mengenai inovasi yang diinisiasi oleh pemerintah kota dan kabupaten sebagai respon terhadap pandemi COVID-19, dengan lebih dari 500  kabupaten dan kota di seluruh Indonesia yang berpartisipasi dan menghasilkan lebih dari 180 inovasi.',
    name: 'ISNA 2020',
    slug: 'isna-2020',
    taxonomy: 'category',
    parent: 90,
...

  {
    ...
    count: 3,
    description:
      'Citiasia Inc. menyediakan layanan pelatihan yang disesuaikan dengan kebutuhan dan bidang industri klien kami. Kami menggabungkan teori implementatif dengan solusi praktis yang relevan untuk klien, pendekatan ini berfokus pada hasil untuk meningkatkan efektivitas dan relevansi pelatihan bagi klien kami.',
    name: 'Training',
    slug: 'training',
    taxonomy: 'category',
    parent: 0,
