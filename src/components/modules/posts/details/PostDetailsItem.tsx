...
const PostDetailsItem: React.FC = () => {
  const text = parse(
    `<p> Pemerintah Provinsi Jawa Barat resmi luncurkan Smart Jabar, sebuah
          ...
          (5/4/2023).</p> 
    <p>“Smart Jabar merupakan aplikasi yang dapat mengakses
    ...
    selaku Kepala Dinas Komunikasi dan Informatika Jawa Barat.</p>

    <p> Hadirnya smart Jabar
    ini berdampak pada peningkatan kualitas layanan bagi internal maupun
    publik dalam mengakses melalui teknologi digital” tutur Ika Mardiah
    ...
    perkembangan baru lagi” papar Setiawan.</p>
      
    <p>
    “Untuk sementara hanya ada dua
    ...
    Melalui peresmian ini,
          ...
          memanfaatkan teknologi digital aplikasi e-Office. 
    </p>

    <p> Sedangkan Dashboard
  ...
  return (
    <div className={styles.postDetailsItem}>
      ...
      <div className={styles.postDetailsItemBody}>
        <div className={styles.postDetailsItemBodyText}>{text}</div>
