...
const ProgramPopulerFigureColumnItem: React.FC<
  ProgramPopulerFigureColumnItemProps
> = ({ id, title, sourceImageUrl, publishDate }) => {
  return (
...
export default ProgramPopulerFigureColumnItem;
